...
import googlePlayBadge from './assets/stores/google-play-badge.svg'
import appStoreBadge from './assets/stores/app-store-badge.svg'
              ...
              {[
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'Firebase (Auth, Database, Storage, Crashlytics, Messaging, Remote Config)',
                    'Play Store',
                    'Compose Multiplatform (KMP, Koin, Ktor, Voyager)',
                    'CI / CD - Bitrise e GitHub Actions',
                  ],
                },
                {
                  title: 'I.A & Produtividade',
                  items: [
                    'Implementar telas a partir do figma via MCP',
                ...
                <div>
                  ...
                  <div className="mt-8 flex flex-wrap items-center gap-3">
                    ...
                    <a
                      ...
                      className={classNames(
                        'inline-flex shrink-0 rounded-lg transition',
                        'hover:-translate-y-0.5 hover:opacity-90 focus-visible:outline-none',
                      )}
                    >
                      <img
                        src={googlePlayBadge}
